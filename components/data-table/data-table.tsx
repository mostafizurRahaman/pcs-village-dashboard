  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ...
        className="table-container overflow-y-auto rounded-md border"
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <TableHead
                    className="group/th relative px-2 py-2 text-left"
                    key={header.id}
            ...
            {isLoading ? (
                          ...
                          {subRowColumns.map((column, colIndex) => {
                            ...
                            return (
                              <TableCell
                                ...
                                className={cn(
                                  "relative h-10 bg-muted/20 px-2 py-2 text-left align-middle text-sm font-medium",
                                  isSortable &&
                              ...
                              >
                                <div className="flex items-center gap-1.5">
                                  ...
                                  {isSortable && (
                                    <span className="text-xs opacity-50 transition-opacity hover:opacity-100">
                                      {isSorted ? (
                                        sortDirection === "asc" ? (
              ...
              <TableRow>
                <TableCell
                  ...
                  className="h-24 truncate text-left"
                >
                  No results.
                </TableCell>
              </TableRow>
