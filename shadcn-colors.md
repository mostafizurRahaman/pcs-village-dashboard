# Shadcn/ui Color Theme (PCS Village)

Based on the Figma design (`janeasuzu || PCS Village`), here are all the major colors converted into standard HSL variables ready to drop into your `app/globals.css` (or equivalent) for `shadcn/ui`.
...
:root {
  --background: oklch(0.9690 0.0053 106.4978);
  ...
  --primary: oklch(0.3462 0.0736 256.0397);
  --primary-foreground: oklch(1.0000 0 0);
  --secondary: oklch(0.6260 0.1305 122.5912);
  --secondary-foreground: oklch(1.0000 0 0);
  --muted: oklch(0.9197 0.0040 286.3202);
  ...
  --ring: oklch(0.3462 0.0736 256.0397);
  --chart-1: oklch(0.3462 0.0736 256.0397);
  --chart-2: oklch(0.6260 0.1305 122.5912);
  --chart-3: oklch(0.3717 0.0392 257.2870);
  --chart-4: oklch(0.4455 0.0374 257.2808);
  --chart-5: oklch(0.5544 0.0407 257.4166);
  --sidebar: oklch(0.3462 0.0736 256.0397);
  --sidebar-foreground: oklch(1.0000 0 0);
  --sidebar-primary: oklch(0.6260 0.1305 122.5912);
  --sidebar-primary-foreground: oklch(1.0000 0 0);
  --sidebar-accent: oklch(0.6260 0.1305 122.5912);
  --sidebar-accent-foreground: oklch(1.0000 0 0);
  --sidebar-border: oklch(0.4037 0.0724 254.4492);
  --sidebar-ring: oklch(0.6260 0.1305 122.5912);
...
.dark {
  ...
  --primary-foreground: oklch(1.0000 0 0);
  --secondary: oklch(0.7681 0.2044 130.8498);
  ...
  --chart-2: oklch(0.7681 0.2044 130.8498);
  --chart-3: oklch(0.7137 0.1434 254.6240);
  --chart-4: oklch(0.8493 0.2073 128.8497);
  ...
  --shadow-sm: 0px 4px 10px 0px hsl(0 0% 0% / 0.30), 0px 1px 2px -1px hsl(0 0% 0% / 0.30);
  --shadow: 0px 4px 10px 0px hsl(0 0% 0% / 0.30), 0px 1px 2px -1px hsl(0 0% 0% / 0.30);
  --shadow-md: 0px 4px 10px 0px hsl(0 0% 0% / 0.30), 0px 2px 4px -1px hsl(0 0% 0% / 0.30);
  --shadow-lg: 0px 4px 10px 0px hsl(0 0% 0% / 0.30), 0px 4px 6px -1px hsl(0 0% 0% / 0.30);
  --shadow-xl: 0px 4px 10px 0px hsl(0 0% 0% / 0.30), 0px 8px 10px -1px hsl(0 0% 0% / 0.30);
